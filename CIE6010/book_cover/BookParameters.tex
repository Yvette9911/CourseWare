...
\def\TheMainTitle{Convex Optimization}
\def\TheSubTitle{CIE6010 Notebook}
\def\TheSubTitleA{Hey!}
\def\TheSubTitleB{Why Not Read This One?}
\def\TheBookSeries{}

\def\TheAuthor{Prof. Yin Zhang}
...
\textsf{\textbf{Grade Descriptor of A} -- Outstanding performance on Mathematical Analysis or some advanced techniques and has the ability to synthesize and apply the basic theory of Mathematical Analysis to novel situations in a manner that would surpass the expectation at this level or could be common at higher levels of study or research.\\
