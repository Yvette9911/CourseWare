...
\booktitle{A Graduate Course \\ In \\
Optimization}

\subtitle{CIE6010 Notebook}

\AuAff{Prof. Yin Zhang\\ The Chinese University of Hongkong, Shenzhen}
...
\begin{notations}
\acro{$X$}{Set}
\acro{$\inf X\subseteq\mathbb{R}$}{Infimum over the set $X$}
